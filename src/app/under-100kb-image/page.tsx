    ...
    <div className="max-w-4xl mx-auto my-12 text-center">
        <Card className="p-6 md:p-8">
            ...
            <CardContent className="space-y-4 text-muted-foreground">
                <p>
                    This tool is specifically designed to compress your images to a file size of less than {TARGET_KB} kilobytes. It's perfect for online application forms or website submissions that have strict file size limits. The tool aggressively optimizes your image to meet the size requirement while trying to maintain as much quality as possible.
                </p>
                <p>
                    <strong>Note:</strong> For very large images (e.g., over 5MB), achieving the {TARGET_KB}KB target may result in a noticeable reduction in quality. The tool will do its best to get as close as possible.
                </p>
                <ToolRelatedBlogLink slug="under-100kb-image" />
            </CardContent>
        </Card>
    </div>
);
export default function Under100kbPage() {
