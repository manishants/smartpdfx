...
const ToolDescription = () => (
    <div className="mt-12">
        <Card className="p-6 md:p-8">
            <CardTitle className="text-2xl font-bold mb-4">Compress Signature to Under {TARGET_KB}KB</CardTitle>
            <CardContent className="space-y-4 text-muted-foreground">
                <p>
                    This tool is specifically designed to compress your signature image to a file size of less than {TARGET_KB} kilobytes. It's perfect for online application forms that require a small signature file. The tool aggressively optimizes your image to meet the size requirement.
                </p>
                <p>
                    <strong>Note:</strong> For images larger than 1MB, achieving the {TARGET_KB}KB target may result in a noticeable reduction in quality. The tool will do its best to get as close as possible.
                </p>
                <ToolRelatedBlogLink slug="30kb-signature-image" />
            </CardContent>
        </Card>
    </div>
);
export default function Signature30kbPage() {
    ...
    <div className="py-8 md:py-12">
      <header className="text-center">
        ...
        <p className="text-lg text-muted-foreground mt-2">
          Reduce the file size of your signature to under {TARGET_KB}KB.
        </p>
      </header>
