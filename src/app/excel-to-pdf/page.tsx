...
const ToolDescription = () => (
    <div className="mt-12">
        <Card className="p-6 md:p-8">
            <CardTitle className="text-2xl font-bold mb-4">Seamless Excel to PDF Conversion</CardTitle>
            <CardContent className="space-y-4 text-muted-foreground">
                <p>
                    Convert your Microsoft Excel spreadsheets (.xls, .xlsx) into professional, easy-to-share PDF documents. Our tool ensures that your formatting, tables, and charts are preserved, creating a perfect snapshot of your work.
                </p>
                <p>
    ...
    <div className="mt-12">
        ...
        <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-2">
                <AccordionTrigger>How is page orientation (Portrait/Landscape) handled?</AccordionTrigger>
                <AccordionContent>
                    The tool attempts to automatically detect the best page orientation for each sheet based on its content. Wide sheets are typically set to landscape, while tall sheets are set to portrait to ensure the best fit.
                </AccordionContent>
            </AccordionItem>
             ...
             <AccordionItem value="item-4">
                <AccordionTrigger>Is there a file size limit for the Excel file?</AccordionTrigger>
                <AccordionContent>
                    While there is no hard limit, we recommend uploading files under 50MB for the fastest and most reliable conversion. Very large or complex Excel files may take longer to process.
                </AccordionContent>
            </AccordionItem>
             <AccordionItem value="item-5">
                <AccordionTrigger>Can I convert a PDF back to Excel?</AccordionTrigger>
                <AccordionContent>
                    Yes! For that, you can use our dedicated <a href="/pdf-to-excel" className="text-primary underline">PDF to Excel Converter</a>, which uses AI to extract tables from PDFs.
                </AccordionContent>
            </AccordionItem>
        </Accordion>
    </div>
...
export default function ExcelToPdfPage() {
  ...
  const handleConvert = async () => {
    ...
    setResult(null);
    try {
      // const excelUri = await fileToDataUri(file);
      // const input = { excelUri };
      // const conversionResult = await excelToPdf(input);
