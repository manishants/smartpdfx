...
import { UploadCloud, FileDown, Loader2, RefreshCw, Type, ImageIcon as ImageIconLucide, Save, Trash2, Wand2, Square, Pen, Highlighter, RotateCcw, ScanText, FileEdit, MousePointer } from "lucide-react";
...
export default function EditPdfPage() {
    ...
    return (
        <div className="w-full h-screen bg-muted/30">
            {stage === 'upload' && (
