...
const teamMembers = [
  {
    ...
    image: "/team/ceo_cofounder_manish_singh_smartpdfx.webp",
  ...
  },
  {
    ...
    name: "Ranjit Shukla",
    title: "Investor",
    description: "Ranjit Shukla, one of the key investors in Smartpdfx, brings with him the discipline, leadership, and vision shaped by his proud service in the Indian Army. During a vacation, Ranjit met Manish Singh and Nishant Singh, who shared their dream of creating a free, Indian-built PDF tool platform. Inspired by their passion and the patriotic mission behind it, he immediately decided to support the venture.\n\nRanjit saw Smartpdfx as more than just a digital tool — he saw it as an opportunity to empower millions of users in India who rely on document tools daily but often face high subscription costs. His belief that technology should be accessible and free for all aligned perfectly with the team's mission.\n\nAs an investor, Ranjit continues to provide strategic guidance and moral support, helping Smartpdfx grow responsibly while staying true to its founding vision. His contribution reflects not only his faith in the project but also his dedication to promoting self-reliance in Indian technology.",
    seoKeywords: "Ranjit Shukla Smartpdfx investor, Indian Army investor, free PDF tools investor India, Smartpdfx funding",
    image: "/team/investor_ranjit_shukla.webp",
  ...
  },
  {
    ...
    image: "/team/nishant_singh_cofounder.webp",
